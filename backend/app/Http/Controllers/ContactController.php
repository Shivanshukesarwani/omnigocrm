...
public function show(Contact $contact){$contact->load(['customer','followUps','calls'=>fn($q)=>$q->latest('called_at'),'activities'=>fn($q)=>$q->with('user')->limit(50)]);return view('contacts.show',['contact'=>$contact]);}
